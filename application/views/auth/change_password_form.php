...
<table>
	<tr>
		<td><?php echo form_label('현재 비밀번호', $old_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label('새 비밀번호', $new_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label('새 비밀번호 확인', $confirm_new_password['id']); ?></td>
...
<?php echo form_submit('change', '비밀번호 바꾸기'); ?>
<?php echo form_close(); ?>