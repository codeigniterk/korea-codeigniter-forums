...
//c_css, c_popup 의 역할?
?>
<form action="<?=$this->uri->uri_string()?>" method="post" name="write_post" enctype="multipart/form-data">
<table width="98%">
<tr>
	<td width="80">글 제목</td>
	<td align="left"><input type="text" value="<?=set_value('subject')?>" size="50" name="subject" />
...
<tr>
	<td>Tag</td>
	<td align="left"><input type="text" value="<?=set_value('tags')?>" size="50" name="tags" /> (예 : 제목, 한국, 홍수)</td>
</tr>
<tr>
	<td>파일첨부</td>
