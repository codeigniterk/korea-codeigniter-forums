...
?>
				<tr align=center>
					...
					<td width="100"><a href="#" title="강제탈퇴" onclick="window.open('http://<?php echo $_SERVER['HTTP_HOST']?>/admin/main/banned/<?php echo $data['user_no']?>', 'him_auth', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=300,height=250')"><?php echo $data['userid']?></a></td>
